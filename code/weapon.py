...
class Weapon(pygame.sprite.Sprite):
    def __init__(self,player,groups):
        ...
        if direction == 'right':
            ...
            self.rect= self.image.get_rect(midright=player.rect.midleft + pygame.math.Vector2(10,8))
        elif direction == 'down':
            self.rect= self.image.get_rect(midtop=player.rect.midbottom + pygame.math.Vector2(-12,-8))
        else:
